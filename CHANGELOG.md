...
- `Addresses::iter` semantics: `iter()` now returns an iterator over the addresses
  in the collection. The address families are flattened into a single iterator.
  Use [`Address::family`] to get the family of each address.
